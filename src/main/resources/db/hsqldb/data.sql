...
-- Products
INSERT INTO products(category_id, collection_id, name, price, description) VALUES ((SELECT id from categories where name='Apparel'),(SELECT id from collections where name='Floppy disc'),'foo', '9.99','description1');
INSERT INTO products(category_id, collection_id, name, price, description) VALUES ((SELECT id from categories where name='Pins'),(SELECT id from collections where name='GameLad'),'bar','5.99','description2');
