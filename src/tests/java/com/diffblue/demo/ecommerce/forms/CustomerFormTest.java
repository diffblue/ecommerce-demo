...
public class CustomerFormTest {
  ...
  public void setEmailInputNotNullOutputVoid() {
    ...
    // Act
    customerForm.setEmail("foo");

    // Assert side effects
    Assert.assertEquals("foo", customerForm.getEmail());
  }
  ...
  public void setLastNameInputNotNullOutputVoid() {
    ...
    // Act
    customerForm.setLastName("foo");

    // Assert side effects
    Assert.assertEquals("foo", customerForm.getLastName());
  }
  ...
  public void setPhoneNumberInputNotNullOutputVoid() {
    ...
    // Act
    customerForm.setPhoneNumber("foo");

    // Assert side effects
    Assert.assertEquals("foo", customerForm.getPhoneNumber());
  }
