...
public class CartController_updateCartItemTest_7_Test {
//failed_compile   @Test
...
//    cartController.updateCartItem(httpServletRequestWrapper, standardSession);
...
//    Assert.assertEquals(1573142873892L, idleTimeInternal);
